...
function deploy_configmap() {
    const configmap = new ConfigMap(service_name, {
        ...
        data: {
            ...
            "urls__grpcBasket": "http://basket-api.eshop.svc.cluster.local:81",
            "urls__grpcCatalog": "http://catalog-api.eshop.svc.cluster.local:81",
            "urls__grpcOrdering": "http://ordering-api.eshop.svc.cluster.local:81",
